let elKino = document.querySelector('.kino__yil');
let elReyting = document.querySelector('.reyting');
...
const  movies = [
    ...
    },
    {
      ...
      "ImageURL": "https://.com/wp-content/uploads/2018/04/Being-Julia-Movie-Poster.jpg",
      "imdb_id": "tt0340012",
      "imdb_rating": 7,
      "runtime": 104,
      "language": "English",
...
movies.map((item)=>{
  ...
  <h3 class="fulltitle">Info:  ${item.fulltitle}</h3>
  <h4 class="year">Year:  ${item.movie_year}</h4>
  <h4 class="raiting">Rating:  ${item.imdb_rating}</h4>
  </div>`
...
elKino.addEventListener('change', (e)=>{
  e.preventDefault()

  elList.innerHTML = ''   
  if (elKino.value == 'eski'){
    movies.sort((a,b)=> a.movie_year - b.movie_year)
  }else if (elKino.value == 'yangi'){
  ...
  movies.map((e)=>{
    let newLi = document.createElement('li')
    newLi.innerHTML =  `<div class="card">
    <h2 class="Title">Title: ${e.Title}</h2>
    <h3 class="fulltitle">Info:  ${e.fulltitle}</h3>
    <h4 class="year">Year:  ${e.movie_year}</h4>
    <h4 class="raiting">Rating:  ${e.imdb_rating}</h4>
    </div>`
    elList.appendChild(newLi)
    newLi.classList.add('items')
    console.log(e);
...
elReyting.addEventListener('change', (e)=>{
  ...
  elList.innerHTML = ''  
  if (elReyting.value == 1){
    movies.sort((a,b)=> a.imdb_rating - b.imdb_rating)
  }else if (elReyting.value == 10){
...
elForm.addEventListener('submit', (e)=>{
  e.preventDefault()
  let elVal = elSearch.value
  elList.innerHTML = ''
  movies.map((i)=>{
    if(i.Title.toLocaleUpperCase().includes(elVal.toLocaleUpperCase()) || i.fulltitle.toLocaleUpperCase().includes(elVal.toLocaleUpperCase())){
      let newLi = document.createElement('li')
    newLi.innerHTML =  `<div class="card">
    <h2 class="Title">Title: ${i.Title}</h2>
    <h3 class="fulltitle">Info:  ${i.fulltitle}</h3>
    <h4 class="year">Year:  ${i.movie_year}</h4>
    <h4 class="raiting">Rating:  ${i.imdb_rating}</h4>
    </div>`
    elList.appendChild(newLi)
    newLi.classList.add('items')    
    }
